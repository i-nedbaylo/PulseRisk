...
**PulseRisk** - учебно-демонстрационный backend-проект на .NET 10, спроектированный под вакансию C# (.NET) Developer Middle+ / Senior в IndigoSoft.
...
- `Вакансия IndigoSoft.md` - исходный текст вакансии.
