...
Вакансия IndigoSoft отдельно подчеркивает глубокое понимание GoF, GRASP и умение избегать overengineering. Поэтому PulseRisk не должен превращаться в каталог паттернов. Наоборот, книга должна показывать инженерную дисциплину: где абстракция нужна, где достаточно прямого кода, а где паттерн пока лучше не вводить.
