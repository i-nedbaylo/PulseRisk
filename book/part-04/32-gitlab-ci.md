...
После главы 31 проект уже запускался через Docker Compose. Теперь нужно перенести основные проверки в pipeline, чтобы они выполнялись не только на машине разработчика.
...
- Добавлена глава `book/part-04/32-gitlab-ci.md`.
