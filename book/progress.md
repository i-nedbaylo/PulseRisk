...
| --- | --- | --- | --- |
| 1. Зачем мы строим PulseRisk | Контекст проекта описан | `chapter-01-vacancy-analysis` | Черновик |
| 2. Анализ вакансии IndigoSoft | Требования вакансии сопоставлены с проектом | `chapter-02-vacancy-fit` | Черновик |
